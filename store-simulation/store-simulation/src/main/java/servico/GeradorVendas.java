...
public class GeradorVendas {
	...
	private static BigDecimal valorIngressos = BigDecimal.valueOf(500);
	...
	public static Venda geraVenda(){
		...
		int qntIngressos = rand.nextInt(10);
		return new Venda(operacao++, 
				cliente, 
				qntIngressos, 
				valorIngressos.multiply(BigDecimal.valueOf(qntIngressos)));
	}
